...
#define ULTRASONIC_SENSOR_TRIG_COMMON_PORT  GPIOD
#define ULTRASONIC_SENSOR_TRIG_COMMON_PAD   0
#define ULTRASONIC_SENSOR_1_ECHO_PORT       GPIOD
#define ULTRASONIC_SENSOR_1_ECHO_PAD        1
